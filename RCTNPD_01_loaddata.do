...
save 		    "${datadir}\1-data\alldata.dta", replace
clear
*** "all data subj" ***
import 		  delimited "${datadir}\1-data\GtOrmondStOutputs2\GtOrmondStAllDataSubj.csv, clear
by          pupilreference, sort: gen unique = _n==1
save 		    "${datadir}\1-data\alldatasubj.dta", replace
clear
*** "link table" ***
import 		  delimited "${datadir}\1-data\GtOrmondStOutputs2\GtOrmondStLinkTable.csv, clear 
by          pupilreference, sort: gen unique_pref = _n==1
by        	studyid1, sort: gen unique_studyid1 = _n==1
save 		    "${datadir}\1-data\linktable.dta", replace
clear
*** "score lookup" ***
import 		  "${datadir}\1-data\GtOrmondStOutputs2\GtOrmondStScoreLookup.csv, clear
...
clear
*** "specification" ***
import delimited "${datadir}\1-data\GtOrmondStOutputs2\GtOrmondStSpecification.csv, varnames(1) clear 
